...
import { getJuanContent } from "@/lib/juan-content";
import Link from "next/link";

export default function JuanLanguageSelector() {
  const content = getJuanContent("en");
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-16 text-center">
        ...
        <p className="font-body mt-3 text-sm text-secondary-foreground">{content.selectorSubtitle}</p>
