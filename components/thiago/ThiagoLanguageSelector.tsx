...
import { HERO_IMAGE, getThiagoContent } from "@/lib/thiago-content";
import Link from "next/link";

export default function ThiagoLanguageSelector() {
  const content = getThiagoContent("en");
    ...
    <div className="relative flex min-h-screen flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-16 text-center">
        ...
        <h1 className="font-heading mt-4 text-5xl font-bold leading-none text-foreground sm:text-7xl">
          <span className="block">Thiago</span>
          <span className="block text-gradient-gold">Cagna</span>
        </h1>
