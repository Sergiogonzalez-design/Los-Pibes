...
import {
  ...
  RACING_PROFILE,
  getAgostinaContent,
} from "@/lib/agostina-content";

type Props = {
  locale: "en" | "es";
};

export default function AgostinaProfilePage({ locale }: Props) {
  const content = getAgostinaContent(locale);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ...
        className="scroll-mt-14 bg-zinc-900/40 py-16 sm:py-24"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
