...
export const metadata: Metadata = {
  title: "Bautista Rossi Molinas — Delantero",
  description:
    "Bautista Rossi Molinas — delantero argentino de Buenos Aires. NCAA División I en Iona (campeón MAAC 2024) y Creighton (Big East).",
};
...
const infoItems = [
  ...
  { k: "Ciudad natal", v: "Buenos Aires, Argentina" },
  { k: "Club en Argentina", v: "Unión de Santa Fe" },
];
...
const seasons = [
  {
    ...
    ast: "2",
    pts: "8",
    note: "1 gol de la victoria · 723 min · según stats oficiales Creighton 2025",
  },
  {
    year: "2024",
    school: "Iona",
    ...
    ast: "2",
    pts: "18",
    note: "All-MAAC Third Team · MAAC All-Championship · GW en la final MAAC vs Rider",
  },
];
...
const milestones = [
  {
    ...
    body: "Segunda temporada con los Bluejays: 15 partidos, 7 titularidades, 3 goles y 2 asistencias (8 puntos) en la Big East. Gol de la victoria vs Omaha; asistencia vs Missouri State.",
  },
  {
    year: "2024",
    title: "Iona — campeón MAAC · All-MAAC Third Team",
    body: "Debut universitario destacado: 8 goles y 18 puntos en 16 partidos (13 titularidades). Marcó en cinco partidos consecutivos en el playoff y anotó el gol de la victoria en la final del MAAC contra Rider (17 nov). All-MAAC Third Team y MAAC All-Championship Team.",
  },
  {
    year: "2024",
    title: "MAAC Rookie of the Week",
    body: "Reconocido como MAAC Rookie of the Week durante su primera campaña en Iona.",
  },
  {
    year: "Origen",
    title: "Buenos Aires · Unión de Santa Fe",
    body: "Delantero argentino de Buenos Aires que se formó en Unión de Santa Fe antes de llegar a la NCAA División I.",
  },
];

export default function BautistaESPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden pt-28 pb-20 sm:pt-36 sm:pb-28">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-body mt-6 max-w-2xl text-lg leading-relaxed text-secondary-foreground md:text-xl">
            Bautista Rossi Molinas es un delantero argentino de Buenos Aires. En su temporada de debut en
            Iona anotó 8 goles, fue seleccionado All-MAAC Third Team y marcó el gol de la victoria en la
            final del campeonato MAAC. Actualmente compite en la Big East con Creighton University.
          </p>
          <p className="font-body mt-4 max-w-2xl text-lg leading-relaxed text-secondary-foreground md:text-xl">
            Goleador decisivo en el playoff, Rossi marcó en cinco partidos seguidos durante la
      ...
      <section id="seasons" className="scroll-mt-14 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 max-w-3xl font-body text-secondary-foreground">
            Totales oficiales partido a partido:{" "}
            <a
              href={IONA_ROSTER}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <table className="w-full min-w-[720px] text-left text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  ...
                  <th className="px-4 py-3 font-body font-semibold text-center">Tit.</th>
      ...
      <section id="highlights" className="scroll-mt-14 bg-zinc-900/40 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 font-body text-secondary-foreground">
            Videos oficiales en YouTube — Iona 2024 y verano 2025.
          </p>
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-1 font-body text-sm text-secondary-foreground">
                Film de la temporada de debut — temporada regular y campeonato MAAC.
              </p>
              <div className="mt-4 overflow-hidden rounded-xl border border-white/10 bg-black/25 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                <div className="aspect-video w-full">
                  <iframe
                    ...
                    title="Bautista Rossi — Highlights 2024"
            ...
            <div>
              ...
              <p className="mt-1 font-body text-sm text-secondary-foreground">
                Reel de highlights del verano 2025.
              </p>
              <div className="mt-4 overflow-hidden rounded-xl border border-white/10 bg-black/25 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                <div className="aspect-video w-full">
                  <iframe
                    ...
                    title="Bautista Rossi — Highlights verano 2025"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerPolicy="strict-origin-when-cross-origin"
                    allowFullScreen
                  />
      ...
      <section id="timeline" className="scroll-mt-14 border-t border-white/10 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 font-body text-secondary-foreground">
            Hitos clave según las bios oficiales de Iona y Creighton.
          </p>
      ...
      <section id="contact" className="scroll-mt-14 border-t border-white/10 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-body mt-2 text-secondary-foreground">
            Consultas de reclutamiento y prensa.
          </p>
