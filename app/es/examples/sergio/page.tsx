    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="seasons" className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 max-w-3xl font-body text-secondary-foreground">
            Números de las temporadas oficiales de Iona (2022–2024) y los datos partido a partido de George Mason 2025. Haz clic en el nombre del colegio para el perfil en vivo:{" "}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            <a href="https://www.youtube.com/watch?v=MXZNl4Gz4sM" target="_blank" rel="noopener noreferrer" className="group rounded-xl border border-white/10 bg-black/20 p-6 transition-colors hover:border-primary/50 hover:bg-black/40">
              ...
              <p className="mt-2 font-body text-sm text-secondary-foreground">Vídeo universitario de Iona — NCAA División I MAAC.</p>
            ...
            <a href="https://www.youtube.com/watch?v=wVKjUAZjyZY&t=3880s" target="_blank" rel="noopener noreferrer" className="group rounded-xl border border-white/10 bg-black/20 p-6 transition-colors hover:border-primary/50 hover:bg-black/40">
              ...
              <p className="mt-2 font-body text-sm text-secondary-foreground">Partido completo de Sergio con el Getafe CF ante el Real Madrid CF (2021).</p>
              <span className="mt-4 inline-block font-body text-sm font-medium text-primary">Ver en YouTube →</span>
            </a>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 overflow-hidden rounded-xl border border-white/10 bg-black/35 shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
            <div className="h-[700px] w-full sm:h-[820px]">
              <iframe
                src="/sergio-gonzalez-report.pdf#toolbar=0&navpanes=0&pagemode=none&zoom=115"
                title="Informe de Rendimiento — Sergio Gonzalez"
      ...
      <section id="timeline" className="border-t border-white/10 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 font-body text-secondary-foreground">Pasos clave alineados con los bios oficiales de Iona y George Mason.</p>
