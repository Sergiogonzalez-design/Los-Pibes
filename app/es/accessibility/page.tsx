...
export const metadata: Metadata = {
  title: "Accesibilidad",
  description: "Declaración de accesibilidad de Onix Media.",
};

export default function AccessibilityPageES() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-3xl px-4 pt-28 pb-16 sm:px-6 sm:pt-32 lg:px-8">
        ...
        <p className="font-body mt-6 rounded-xl border border-white/10 bg-black/30 px-5 py-4 text-sm text-secondary-foreground">
          Este documento está disponible en inglés. / This document is available in English.
        </p>
