...
export const metadata: Metadata = {
  title: "Bautista Rossi Molinas — Select Language",
  description:
    "Bautista Rossi Molinas — Forward · NCAA Division I. Select your language.",
};

export default function BautistaLanguageSelector() {
  return (
    <div
      className="relative flex min-h-screen flex-col"
      style={{
        backgroundImage:
          "linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.65) 60%, rgba(0,0,0,0.85) 100%), url('/Bautista gritando.jpg')",
    ...
    >
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 pb-16 text-center">
        ...
        <p className="font-body mt-3 text-sm text-secondary-foreground">
          Iona University · Creighton University
        </p>
