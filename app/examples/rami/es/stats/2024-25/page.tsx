...
export default function RamiEsStats2425Page() {
  return (
    ...
    >
      <SiteHeader
        backHref="/examples/rami/es"
        backAriaLabel="Volver al perfil"
        menuLabel="Menú"
        badge="PR15"
        items={[
          { type: "link", href: "/examples/rami/es", label: "Perfil" },
          { type: "link", href: "/examples/rami/es/stats/2025-26", label: "2025/26" },
          { type: "link", href: "/examples/rami/es/stats/2024-25", label: "2024/25", active: true },
        ]}
      />
