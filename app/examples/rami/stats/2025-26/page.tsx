...
const matches = [
  { date: "03 May", home: "NAV", away: "FUE", score: "3–1", min: 90, goal: true,  yellow: false, red: false, rating: 7.6 },
  { date: "26 Apr", home: "FUE", away: "MAJ", score: "0–0", min: 90, goal: false, yellow: false, red: false, rating: 7.0 },
  { date: "19 Apr", home: "UDS", away: "FUE", score: "2–3", min: 90, goal: false, yellow: false, red: false, rating: 6.6 },
  { date: "05 Apr", home: "QRE", away: "FUE", score: "1–0", min: 90, goal: false, yellow: true,  red: false, rating: 5.5 },
  { date: "28 Mar", home: "FUE", away: "RMA", score: "1–1", min: 90, goal: false, yellow: false, red: false, rating: 6.2 },
  { date: "22 Mar", home: "ELC", away: "FUE", score: "2–3", min: 6,  goal: false, yellow: false, red: false, rating: 4.8 },
  { date: "15 Feb", home: "FUE", away: "LPA", score: "1–1", min: 90, goal: false, yellow: false, red: false, rating: 6.3 },
  { date: "07 Feb", home: "COL", away: "FUE", score: "3–0", min: 44, goal: false, yellow: false, red: false, rating: 4.7 },
  { date: "01 Feb", home: "FUE", away: "UBC", score: "0–1", min: 90, goal: false, yellow: false, red: false, rating: 5.6 },
  { date: "24 Jan", home: "RVB", away: "FUE", score: "1–2", min: 90, goal: false, yellow: false, red: false, rating: 6.7 },
  { date: "17 Jan", home: "FUE", away: "COR", score: "1–2", min: 90, goal: false, yellow: false, red: false, rating: 5.6 },
  { date: "11 Jan", home: "FUE", away: "CDT", score: "1–1", min: 90, goal: false, yellow: false, red: false, rating: 6.1 },
  { date: "04 Jan", home: "ALC", away: "FUE", score: "0–0", min: 90, goal: false, yellow: false, red: false, rating: 6.8 },
  { date: "20 Dec", home: "FUE", away: "ELC", score: "1–1", min: 90, goal: false, yellow: false, red: false, rating: 6.1 },
  { date: "13 Dec", home: "MAJ", away: "FUE", score: "1–0", min: 90, goal: false, yellow: true,  red: false, rating: 5.6 },
  { date: "07 Dec", home: "FUE", away: "QRE", score: "2–1", min: 90, goal: false, yellow: false, red: false, rating: 6.4 },
  { date: "30 Nov", home: "FUE", away: "COL", score: "3–0", min: 90, goal: false, yellow: false, red: false, rating: 7.3 },
  { date: "23 Nov", home: "UBC", away: "FUE", score: "2–0", min: 90, goal: false, yellow: true,  red: false, rating: 5.1 },
  { date: "08 Nov", home: "RMA", away: "FUE", score: "3–1", min: 90, goal: false, yellow: false, red: false, rating: 5.4 },
  { date: "02 Nov", home: "CDT", away: "FUE", score: "1–3", min: 90, goal: false, yellow: false, red: false, rating: 6.8 },
  { date: "26 Oct", home: "FUE", away: "UDS", score: "1–1", min: 14, goal: false, yellow: false, red: false, rating: 4.8 },
  { date: "19 Oct", home: "COR", away: "FUE", score: "2–0", min: 5,  goal: false, yellow: false, red: false, rating: 4.7 },
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-background/85 backdrop-blur-md">
        <nav className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-2 sm:px-6 lg:px-8">
          ...
          <ul className="flex flex-wrap items-center justify-end gap-x-4 gap-y-2 font-body text-sm font-medium text-secondary-foreground">
            ...
            <li><Link href="/examples/rami/stats/2025-26" className="text-primary">2025/26</Link></li>
            <li><Link href="/examples/rami/stats/2024-25" className="transition-colors hover:text-primary">2024/25</Link></li>
          </ul>
        </nav>
      </header>
