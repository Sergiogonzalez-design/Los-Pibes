      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-background/85 backdrop-blur-md">
        <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex min-w-0 items-center gap-4">
            <Link href="/examples/rami/en" className="shrink-0 font-body text-sm text-secondary-foreground transition-colors hover:text-primary" aria-label="Back to profile">←</Link>
          ...
          <ul className="flex flex-wrap items-center justify-end gap-x-4 gap-y-2 font-body text-sm font-medium text-secondary-foreground">
            <li><Link href="/examples/rami/en" className="transition-colors hover:text-primary">Profile</Link></li>
            <li><Link href="/examples/rami/en/stats/2025-26" className="text-primary">2025/26</Link></li>
            <li><Link href="/examples/rami/en/stats/2024-25" className="transition-colors hover:text-primary">2024/25</Link></li>
          </ul>
        </nav>
      </header>
