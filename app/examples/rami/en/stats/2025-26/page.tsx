...
export default function RamiEnStats2526Page() {
  return (
    ...
    >
      <SiteHeader
        backHref="/examples/rami/en"
        backAriaLabel="Back to profile"
        menuLabel="Menu"
        badge="PR15"
        items={[
          { type: "link", href: "/examples/rami/en", label: "Profile" },
          { type: "link", href: "/examples/rami/en/stats/2025-26", label: "2025/26", active: true },
          { type: "link", href: "/examples/rami/en/stats/2024-25", label: "2024/25" },
        ]}
      />
