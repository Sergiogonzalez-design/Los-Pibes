      ...
      <section className="relative overflow-hidden pt-36 pb-20 sm:pt-44 sm:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-body mt-6 max-w-2xl text-lg leading-relaxed text-secondary-foreground md:text-xl">
            Pablo &ldquo;Rami&rdquo; Ramirez Moreno is a Spanish center back
            formed in the academy of Getafe CF — one of La Liga&apos;s most
            respected development programs. After earning a first-team call-up
            at Getafe and two productive seasons at Leganés B, he is currently
            competing for Fuenlabrada in the Segunda Federación.
          </p>
          ...
          <div className="mt-8 overflow-hidden rounded-xl border border-white/10 bg-black/35 shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
            <div className="h-[700px] w-full sm:h-[820px]">
              <iframe
                ...
                title="Performance Report — Pablo Ramirez Moreno"
                className="h-full w-full"
              />
            </div>
          </div>
