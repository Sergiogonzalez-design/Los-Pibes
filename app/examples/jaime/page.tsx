...
export const metadata: Metadata = {
  title: "Jaime Roman Jr. — Select Language",
  description: "Jaime Roman Jr. — Defender · NCAA Division I · Iona University. Select your language.",
};

export default function JaimeLanguageSelector() {
  return (
    <div
      className="relative flex min-h-screen flex-col"
      style={{
        backgroundImage:
          "linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.65) 60%, rgba(0,0,0,0.85) 100%), url('/Jaime Roman 2.jpg')",
