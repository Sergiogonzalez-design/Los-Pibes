...
export const metadata: Metadata = {
  title: "Nacho Alfaro — Select Language",
  description:
    "Ignacio 'Nacho' Alfaro Monge — Goalkeeper · Costa Rica. Select your language.",
};

export default function NachoLanguageSelector() {
  return (
    <div
      className="relative min-h-screen flex flex-col"
      style={{
        backgroundImage:
          "linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.65) 60%, rgba(0,0,0,0.85) 100%), url('/Nacho jugando.jpeg')",
    ...
    >
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 pb-16 text-center">
        ...
        <p className="font-body mt-3 text-sm text-secondary-foreground">
          Iona University · Florida Atlantic University
        </p>
